package com.nfinity.ll.ttestapp1.emailbuilder.emailconverter.utils;

import static com.nfinity.ll.ttestapp1.emailbuilder.emailconverter.utils.CommonUtil.checkValue;
...
import com.nfinity.ll.ttestapp1.emailbuilder.emailconverter.dto.request.Background;
import com.nfinity.ll.ttestapp1.emailbuilder.emailconverter.dto.request.Border;
import com.nfinity.ll.ttestapp1.emailbuilder.emailconverter.dto.request.Elements;
import com.nfinity.ll.ttestapp1.emailbuilder.emailconverter.dto.request.Height;
import com.nfinity.ll.ttestapp1.emailbuilder.emailconverter.dto.request.LineHeight;
import com.nfinity.ll.ttestapp1.emailbuilder.emailconverter.dto.request.Options;
import com.nfinity.ll.ttestapp1.emailbuilder.emailconverter.dto.request.Padding;
import com.nfinity.ll.ttestapp1.emailbuilder.emailconverter.dto.request.Request;
import com.nfinity.ll.ttestapp1.emailbuilder.emailconverter.dto.request.Size;
import com.nfinity.ll.ttestapp1.emailbuilder.emailconverter.dto.request.Structures;
import com.nfinity.ll.ttestapp1.emailbuilder.emailconverter.dto.request.Width;
...
public class EmailMjmlTemplateGenrator {
	...
	private String text2String(String path) throws IOException {
		InputStream inputStream = getClass().getClassLoader()
                .getResourceAsStream("emailBuilderFiles" + path);
		String body ="";
		if(inputStream != null) {
